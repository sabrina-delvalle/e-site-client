        ...
        <nav className="grid col-span-2 grid-cols-2 hover:cursor-default">
          ...
          <ul className="flex flex-row col-span-1 justify-end items-center">
            <li className="flex justify-end">
              <input placeholder="search" className="w-3/5 focus:w-4/5 h-9 rounded-xl placeholder:text-neutral-500 placeholder:font-light border-[1px] pl-2 m-3 text-neutral-700" />
            </li>
            <li>
